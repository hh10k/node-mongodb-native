...
Server.prototype.connect = function(dbInstance, options, callback) {
  ...
  var __attemptReconnect = function(server) {
    if (server._reconnectTimeout) return;
    server._reconnectTimeout = setTimeout(function() {
      server._reconnectTimeout = undefined;
      // Attempt reconnect
